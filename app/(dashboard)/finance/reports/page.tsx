...
const OPERATIONAL_REPORTS = [
  ...
  },
  {
    ...
    title: 'Cash Book',
    description: 'Detailed listing of all cash and bank transactions with running balances.',
    icon: Wallet,
  ...
  },
  {
    ...
    description: 'Match bank statement lines to GL journal entries and identify unreconciled items.',
    icon: FileBarChart,
  ...
  },
  {
    ...
    description: 'Compare budgeted amounts to actual income and expenditure for each period.',
    icon: PieChart,
