    ...
    items: [
      {
        ...
        children: [
          ...
          { href: '/finance/reports/sales-book',          label: 'Sales Book',        icon: BookOpen },
          { href: '/finance/reports/purchase-book',       label: 'Purchase Book',     icon: ShoppingCart },
          { href: '/finance/reports/cash-book',           label: 'Cash Book',         icon: Wallet },
          { href: '/finance/reports/bank-book',           label: 'Bank Book',         icon: Building2 },
          { href: '/finance/reports/expense-list',        label: 'Expense Report',    icon: CreditCard },
          { href: '/finance/reports/fixed-assets-register', label: 'Fixed Assets',   icon: Landmark },
          { href: '/finance/reports/inventory',           label: 'Inventory',         icon: Package },
          { href: '/finance/reports/budget',              label: 'Budget vs Actuals', icon: TrendingUp },
          { href: '/finance/reports/bank-reconciliation', label: 'Bank Reconciliation', icon: FileBarChart },
        ],
      },
      {
        href: '/reports',
